...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create college-project-3db1
  fly apps create college-project-3db1-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app college-project-3db1
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app college-project-3db1-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'college-project-3db1-staging' does not match app name in config file 'college-project-3db1'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name college-project-3db1-db
  fly postgres attach --app college-project-3db1 college-project-3db1-db

  fly postgres create --name college-project-3db1-staging-db
  fly postgres attach --app college-project-3db1-staging college-project-3db1-staging-db
  ```
